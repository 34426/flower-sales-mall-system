<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="鲜花分类" prop="xianhuafenlei">
          <el-input v-model="ruleForm.xianhuafenlei" 
              placeholder="鲜花分类" clearable  :readonly="ro.xianhuafenlei"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xianhuafenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xianhuafenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
